...
Based on this information, critically determine the specific resources and their quantities required to support this zone.
CRITICAL: You must tailor the resources to the specific type of disaster (${disasterName}). For example, a flood requires boats and water purifiers, an earthquake requires heavy rescue equipment, and a fire requires burn kits and respirators. Do NOT just use generic examples.
...
Keep the list focused to 3-6 critical resource types specific to this disaster.

Example structure:
{
  "resources": [
    {"resource_type": "[Disaster Specific Resource 1]", "quantity_needed": 100},
    {"resource_type": "[Disaster Specific Resource 2]", "quantity_needed": 50},
    {"resource_type": "[Generic Resource like Water]", "quantity_needed": 1000}
  ]
}
`;
